...
from psyneulink.globals.log import LogEntry, ContextState
...
class ControlSignal(ModulatorySignal):
    ...
    #         if (log_pref is ContextState.ALL_ASSIGNMENTS or
    #                 (log_pref is ContextState.EXECUTION and EXECUTING in context) or
    #                 (log_pref is ContextState.VALUE_ASSIGNMENT and (EXECUTING in context))):
    #             # record info in log
    #
