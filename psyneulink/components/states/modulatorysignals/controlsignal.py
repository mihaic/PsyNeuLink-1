...
class ControlSignal(ModulatorySignal):
    ...
    #         if (log_pref is ContextStatus.ALL_ASSIGNMENTS or
    #                 (log_pref is ContextStatus.EXECUTION and EXECUTING in context) or
    #                 (log_pref is ContextStatus.VALUE_ASSIGNMENT and (EXECUTING in context))):
    #             # record info in log
    #
