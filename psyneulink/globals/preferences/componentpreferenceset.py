...
SystemDefaultPreferencesDict = {
    ...
    kpLogPref: PreferenceEntry(ContextState.OFF, PreferenceLevel.CATEGORY),
...
TypeDefaultPreferencesDict = {
    ...
    kpLogPref: PreferenceEntry(ContextState.OFF, PreferenceLevel.CATEGORY),   # This gives control to Mechanisms
...
class ComponentPreferenceSet(PreferenceSet):
    ...
    Description:
        Implement the following preferences:
            ...
            - log (bool): sets ContextState for a given Component
